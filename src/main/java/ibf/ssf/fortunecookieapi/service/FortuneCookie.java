package ibf.ssf.fortunecookieapi.service;
...
public class FortuneCookie {
	...
	public String getCookie() {
		return COOKIES[random.nextInt(COOKIES.length)];
	}

	public List<String> getCookies(Integer num) {
		List<Integer> indices = IntStream.range(1, COOKIES.length).boxed().collect(Collectors.toList());
